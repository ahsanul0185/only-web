...
import targetGif from "../assets/target.JPEG.jpg";
  ...
  const {t} = useTranslation();
    return (
        <motion.div
            ref={ref}
            variants={variants}
            className='h-fit md:h-[500px] w-full md:flex-[30%] bg-black border border-gray-200/40 rounded-lg p-6 flex flex-col gap-4'
        >
            <img src={card.image} className='w-[80%] mx-auto md:w-full md:h-[60%] bo rder border-gray-200/40 rounded-lg object-cover' alt={card.title} />
