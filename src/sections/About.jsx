    ...
    <SectionTitle>Who Are We?***Qui somme nous ?</SectionTitle>
      <div className='default-padding pt-12'>
        <div className='text-base md:text-lg mb-12 text-white/95'>
          ...
          <p className='inline ml-2'>{t("Our team is made up of creative designers and experienced developers who master web technologies — HTML, CSS, JavaScript, and much more.***Notre équipe est composée de designers créatifs et de développeurs expérimentés qui maîtrisent les technologies du web — HTML, CSS, JavaScript et bien plus encore.")}</p>
